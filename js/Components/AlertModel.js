...
export default class AlertModel extends Component {
  ...
  render () {
    ...
    let titleIsNull = global.util.isNull(title)
    let contentIsNull = global.util.isNull(content)
    let okIsNull = global.util.isNull(btnInfo.ok)
    let cancelIsNull = global.util.isNull(btnInfo.cancel)
      ...
      >
        <View style={styles.alertView}>
          ...
          <View style={styles.btnView}>
            {
              cancelIsNull ? null : <TouchableHighlight
            ...
            {
              okIsNull ? null : <TouchableHighlight
