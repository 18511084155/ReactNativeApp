...
import { NetInfo, Platform, View, Image, StyleSheet, TouchableHighlight } from 'react-native'
 ...
 */
const WithConnection = (ComposedComponent, navigationOptions = {}) => class extends React.Component {
  constructor () {
    super(...arguments)
    ...
    if (this.state.isConnected) {
      ...
      return (
        <View style={styles.contentView}>
          ...
          <View>
            <TouchableHighlight underlayColor={'rgba(225, 225, 225, 0.75)'} onPress={() => {
              NetInfo.isConnected.fetch().done((isConnected) => {
                this._handleIsConnected(isConnected)
              })
            }}>
