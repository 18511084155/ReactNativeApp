...
public class Res {
	...
	public static int drawable(String name) {
		return identifier(name, "build/intermediates/exploded-aar/com.cz.widget/widget-library/1.0.2/res/drawable");
	}
	...
	public static int layout(String name) {
		return identifier(name, "build/intermediates/exploded-aar/com.cz.widget/widget-library/1.0.2/res/layout");
	}
	...
	public static int anim(String name) {
		return identifier(name, "build/intermediates/exploded-aar/com.facebook.react/react-native/0.51.1/res/anim");
	}
	...
	public static int color(String name) {
		return identifier(name, "build/intermediates/exploded-aar/com.android.support/appcompat-v7/24.2.1/res/color");
	}
